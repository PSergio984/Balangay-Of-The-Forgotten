...
Save to `Assets/Prefabs/Leaderboard/LeaderboardPanel.prefab`.
...
- [ ] `rowPrefab` is set to the `LeaderboardEntryRow` prefab
...
- feat(leaderboard): create LeaderboardEntryRow prefab
